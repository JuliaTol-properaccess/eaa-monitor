  ...
  <main id="main">
    ...
    <section>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-20">
        <h1 class="text-4xl md:text-5xl font-semibold text-navy leading-[1.08] tracking-tight max-w-3xl">Vind een WCAG-audit</h1>
        <p class="mt-6 text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed">Een onafhankelijke audit brengt in kaart of je website en app voldoen aan de WCAG en de European Accessibility Act. Hieronder vind je auditbureaus in Nederland.</p>
      </div>
    </section>
