  ...
  <main id="main">
    ...
    <section class="bg-navy text-white on-dark">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-20">
        ...
        <p class="mt-6 text-lg md:text-xl text-white max-w-2xl leading-relaxed">Een onafhankelijke audit brengt in kaart of je website en app voldoen aan de WCAG en de European Accessibility Act. Hieronder vind je auditbureaus in Nederland.</p>
      </div>
    </section>
